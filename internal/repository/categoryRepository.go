...
func (c *CategoryRepository) GetCategoryByUserID(ctx context.Context, userId uuid.UUID) ([]models.Category, error) {
...
func (c *CategoryRepository) CheckUserExists(ctx context.Context, id uuid.UUID) error {
	sql := `SELECT COUNT(1) FROM categories WHERE user_id = $1`
