...
func (r *CreditCardRepository) FetchAllByUserID(ctx context.Context, userID uuid.UUID) ([]models.CreditCard, error) {
...
func (r *CreditCardRepository) FetchOneByID(ctx context.Context, id uuid.UUID) (*models.CreditCard, error) {
...
func (r *CreditCardRepository) Create(ctx context.Context, cc *models.CreditCard) error {
